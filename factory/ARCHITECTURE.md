...
The built-in Bedrock, Claude, Codex, and Cursor adapters enforce the planning
JSON schemas. Supervision, implementation, QA, and code review accept any lowercase
