...
class Factory:
    ...
    def make_prompt(self, ticket: dict, failure: str) -> Path:
        ...
        path.write_text(
            ...
            "Name the candidate by pasting the output of `git rev-parse HEAD` verbatim (all 40 characters; "
            "an abbreviation of at least 7 characters of that same value is also accepted). "
            "Include actual checks and artifact paths, input/policy hashes "
