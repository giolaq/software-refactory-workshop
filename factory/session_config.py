...
PLANNING_AGENTS = {"bedrock", "claude", "codex", "pi"}
...
PRESETS = {
    ...
    "bedrock-aws": {
        ...
        "agent": "bedrock",
        "qa_agent": "bedrock",
        "supervisor_agent": "bedrock",
        "review_agent": "bedrock",
        "planning_agent": "bedrock",
        "review_qa_tests": True,
        "max_parallel": 1,
    },
}
...
def validate_session_config(value: dict) -> dict:
    ...
    if "planning_agent" in value and value["planning_agent"] not in PLANNING_AGENTS:
        raise ValueError("planning_agent must be bedrock, claude, codex, or pi")
