...
class FactoryContractTests(unittest.TestCase):
    ...
    def test_cli_exposes_frozen_workshop_version(self):
        ...
        self.assertEqual(result.stdout.strip(), "factory workshop-v1.1.3")
    ...
    def test_release_check_audits_clean_versioned_tree(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            (repo / "factory/factory_contracts.py").write_text('WORKSHOP_VERSION = "workshop-v1.1.3"\n')
            (repo / "factory/WORKSHOP_OUTLINE.md").write_text("# workshop-v1.1.3\n")
            (repo / "factory/FACILITATOR.md").write_text("# workshop-v1.1.3\n")
            (repo / "workshop-guide/app/page.tsx").write_text("workshop-v1.1.3\n")
